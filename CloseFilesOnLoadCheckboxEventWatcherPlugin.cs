//Developed for Navisworks Manage 2022, targetting the 4.7.2 .NET Framework.
    ...
    public class CloseFilesOnLoadCheckboxEventWatcherPlugin : EventWatcherPlugin
    {
        public override void OnLoaded()
        {
            if (!ApplicationControl.CloseFileAfterLoad)
            {
                ...
                MessageBox.Show(
                    "Since the 'Close NWC/NWD files on load' checkbox was identified to be unchecked while opening Navisworks Manage, it has now been automatically ticked." +
                    "\n" + "\n" +
